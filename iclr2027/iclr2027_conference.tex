...
A representation that retains $X_{\mathrm{loc}}$ therefore differs across sensitive values near $s_0$, so a head using it has $\Delta_f(s)>0$ there and nowhere else.
