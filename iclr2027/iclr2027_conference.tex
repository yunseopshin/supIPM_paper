...
\begin{figure}[!htb]
  \centering
  \includegraphics[width=0.92\textwidth]{main/fig2p_adult.pdf}
  \caption{Adult: test accuracy against the prediction-level disparity $\widehat{\operatorname{GDP}}_{\infty}(f_{\psi}\circ h_{\phi})$ (left, middle), and $\widehat{\Delta}(s)$ of the worst-case heads $\hat{f}_1$ of supIPM-FRL and FREM at the configurations with the smallest worst-case disparity among those whose test accuracy is within $0.004$ of the model trained without a penalty (right).}
  \label{fig:adult}
  \vspace{-12pt}
\end{figure}
