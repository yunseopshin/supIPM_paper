...
%   \qquad
%   Y:=\sigma\!\left(\mathbf{u}^\top\mathbf{X}_{\mathrm{task}}+X_{\mathrm{loc}}+0.3\,\varepsilon_2\right),
% \end{equation*}
% with $s_0=0.5$, $\tau=0.043$ and a fixed $\mathbf{u}\in\mathbb{R}^4$.  The input is $\mathbf{X}:=(\mathbf{X}_{\mathrm{task}},X_{\mathrm{loc}},\mathbf{X}_{\mathrm{noise}})$.
...
% The value of $\mathbf{u}$, the sample sizes and the training settings are given in Appendix~\ref{app:synth-experiments}.
...
Y:=\sigma\!\left(\mathbf{u}^\top\mathbf{X}_{\mathrm{task}}+X_{\mathrm{loc}}+0.3\,\varepsilon_2\right),
\end{equation*}
where $s_0=0.5$, $\tau=0.043$ and $\mathbf{u}\in\mathbb{R}^4$ is given.
