...
We generate $S$ uniformly on an interval.  A single input variable depends on $S$ through a term concentrated near a value $s_0$, and the outcome $Y$ does not depend on $S$.
