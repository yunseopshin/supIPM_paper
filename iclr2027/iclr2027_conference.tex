...
They may therefore achieve low disparity for the trained head while leaving dependence that another downstream head can exploit, leading to larger worst-case disparity.
