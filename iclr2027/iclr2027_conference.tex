...
\begin{itemize}[leftmargin=*, itemsep=0pt, topsep=2pt]
  ...
  \item Crime \citep{communities_and_crime_183}: $Y$ is the violent crime rate of a community and $S$ is the proportion of Black residents.
  \item ACSIncome \citep{ding2021retiring}: $Y$ is income in the 2018 American Community Survey and $S$ is age.
\end{itemize}
