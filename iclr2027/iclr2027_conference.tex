...
$p(s) \propto 1-0.9\exp\{-(s-s_0)^2/(2\tau^2)\}$, $\mathbf{X}_{\mathrm{task}}\sim N(\mathbf{0},\mathbf{I}_4)$, $\mathbf{X}_{\mathrm{noise}}\sim N(\mathbf{0},\mathbf{I}_3)$ and $\varepsilon_2, \varepsilon_{3}\sim N(0,1)$, and set
\begin{equation*}
X_{\mathrm{loc}}:=3\exp\!\left\{-\frac{(S-s_0)^2}{2\tau^2}\right\}+0.5\,\varepsilon_2,
\qquad
Y:=\sigma\!\left(\boldsymbol{\upsilon}^\top\mathbf{X}_{\mathrm{task}}+\exp\!\left\{-\frac{(S-s_0)^2}{2\tau^2}\right\}+0.3\,\varepsilon_3\right),
\end{equation*}
...
\begin{alignedat}{2}
  ...
  &X_{\mathrm{loc}}:=3\,\omega(S)+0.5\,\varepsilon_2.
\end{alignedat}
\label{eq:synth-common}
\end{equation}
where $\varepsilon_2, \varepsilon_3\sim N(0,1)$, and $S$, $\mathbf{X}_{\mathrm{task}}$, $\mathbf{X}_{\mathrm{noise}}$, $\varepsilon_2$ and $\varepsilon_3$ are mutually independent.
...
\begin{equation}
\begin{aligned}
  Y &:= \sigma\!\left(\boldsymbol{\upsilon}^\top\mathbf{X}_{\mathrm{task}}+\omega(S) + 0.3\,\varepsilon_3\right), \\
