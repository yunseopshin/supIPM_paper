...
\begin{itemize}
  ...
  \item {\bf Empirical studies blablabla...}
...
\begin{figure}[!htb]
  ...
  \caption{Prediction performance against the prediction-level $L_{\infty}$-GDP on Crime (top) and ACSIncome (bottom).}
