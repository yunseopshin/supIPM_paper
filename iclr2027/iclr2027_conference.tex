...
In this work, we used generative AI tools to assist with writing and reviewing the manuscript, synthesizing and organizing experimental results, and searching for relevant literature and research materials.
We reviewed and verified all AI-assisted content before including it in the paper.
...
Appendix~\ref{app:mixture-em} provides the details of MoDGF, including its initialization, structured mean-field E-step, generalized M-step, and overall training algorithm. 
Appendix~\ref{app:experimental-details} provides the experimental settings, including the datasets and evaluation metrics, model architectures, SGLD sampling procedure, baseline implementations, specialist inference methods, and OOD detection setup.
Additional analyses of computational costs and the main design choices of MoDGF are provided in Appendices~\ref{app:computational-costs} and~\ref{app:ablation}, respectively.
