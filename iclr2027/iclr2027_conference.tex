...
\begin{remark}
    \label{rem:sup-mmd}
    Unlike the worst-case disparity shown in \ref{fig:simulation}, FREM exhibits high $\widehat{\Delta}_{\hat{f}_1}(s)$ across the sensitive domain in Figure~\ref{fig:profile-adult}.
